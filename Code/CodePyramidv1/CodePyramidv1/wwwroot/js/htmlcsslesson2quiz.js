var quiz1 = (function () {
    ...
    function selectq5c4() {
        q5c4.style.border = "5px solid green";
        q5c2.style.border = "";
        q5c3.style.border = "";
        q5c1.style.border = "";
        chosenAnswers[4] = 4;
    ...
    function gradeTest() {
        ...
        document.getElementById("assessmentName").value = "HTML/CSS Quiz 2";

        document.getElementById("htmlquiz2form").submit();
    ...
    function init() {
        ...
        q5c4.addEventListener("click", selectq5c4);
